...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group pay-cc-selector">
                <input type="radio" id="mastercard" name="payment_method" value="mastercard" required>
                <label class="pay-drinkcard-cc pay-mastercard" for="mastercard"></label>

                <input type="radio" id="visa" name="payment_method" value="visa" required>
                <label class="pay-drinkcard-cc pay-visa" for="visa"></label>

                <input type="radio" id="paypal" name="payment_method" value="paypal" required>
                <label class="pay-drinkcard-cc pay-paypal" for="paypal"></label>

                <input type="radio" id="americanexpress" name="payment_method" value="americanexpress" required>
                <label class="pay-drinkcard-cc pay-americanexpress" for="americanexpress"></label>

                <input type="radio" id="maestro" name="payment_method" value="maestro" required>
                <label class="pay-drinkcard-cc pay-maestro" for="maestro"></label>
