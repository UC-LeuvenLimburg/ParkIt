<template>
  <div class="autocomplete">
    ...
    ></div>
    <div class="autocomplete-placeholder" v-if="selectedItem == null" v-text="placeholder"></div>
    <button class="autocomplete-close" @click="selectionCanceled" v-if="selectedItem">x</button>
  ...
  methods: {
    ...
    selectItem() {
      ...
      if (this.outputkey == "") {
        ...
        this.$emit(
          "selected",
          JSON.parse(JSON.stringify(this.selectedItem))[this.outputkey]
        );
      }
    },
    up() {
